...
insert into public.product_applications (product_id, application_id) values
  ...
  ('b1111111-1111-4111-8111-111111111111','c2222222-2222-4222-8222-222222222222'),
  ('b1111111-1111-4111-8111-111111111111','c4444444-4444-4444-8444-444444444444'),
  ('b1111111-1111-4111-8111-111111111111','c6666666-6666-4666-8666-666666666666'),
  -- custom-pvc-rubber-patches
  ('b2222222-2222-4222-8222-222222222222','c1111111-1111-4111-8111-111111111111'),
  ('b2222222-2222-4222-8222-222222222222','c2222222-2222-4222-8222-222222222222'),
  ('b2222222-2222-4222-8222-222222222222','c4444444-4444-4444-8444-444444444444'),
  ('b2222222-2222-4222-8222-222222222222','c5555555-5555-4555-8555-555555555555'),
  ('b2222222-2222-4222-8222-222222222222','c9999999-9999-4999-8999-999999999999'),
  -- hook-and-loop-rubber-patches
  ('b3333333-3333-4333-8333-333333333333','c5555555-5555-4555-8555-555555555555'),
  ('b3333333-3333-4333-8333-333333333333','c4444444-4444-4444-8444-444444444444'),
  ('b3333333-3333-4333-8333-333333333333','c1111111-1111-4111-8111-111111111111'),
  ('b3333333-3333-4333-8333-333333333333','c8888888-8888-4888-8888-888888888888'),
  -- earphone-hole-patches
  ('b4444444-4444-4444-8444-444444444444','c4444444-4444-4444-8444-444444444444'),
  ('b4444444-4444-4444-8444-444444444444','c6666666-6666-4666-8666-666666666666'),
  -- keychains
  ('b5555555-5555-4555-8555-555555555555','c9999999-9999-4999-8999-999999999999'),
  ('b5555555-5555-4555-8555-555555555555','c8888888-8888-4888-8888-888888888888')
